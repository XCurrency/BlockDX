...
public:
    ...
    void refreshPeers() {
        ...
        // Try to retrieve the CNodeStateStats for each node.
        {
            ...
            if (lockMain) {
                BOOST_FOREACH (CNodeCombinedStats &stats,
                               cachedNodeStats)stats.fNodeStateStatsAvailable = GetNodeStateStats(
        ...
        mapNodeRows.clear();
        int row = 0;
        BOOST_FOREACH (CNodeCombinedStats &stats, cachedNodeStats)mapNodeRows.insert(
