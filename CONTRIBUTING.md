Contributing to xc3 Core
============================

The xc3 Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the xc3 unit tests or QA tests
...
The following applies to code changes to the xc3 Core project, and is not to be
confused with overall xc3 Network Protocol consensus changes.

Whether a pull request is merged into xc3 Core rests with the project merge
...
Patches that change xc3 consensus rules are considerably more involved than
...
Where a patch set proposes to change the xc3 consensus, it must have been
...
The project leader is the release manager for each xc3 Core release.
