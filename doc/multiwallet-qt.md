...
In order to support loading of multiple wallets in xc3dx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xc3dx.cpp.
...
Changes to xc3dx.cpp
----------------------
xc3dx.cpp is the entry point into xc3dx-qt, and as such, will require some minor modifications to provide hooks for
